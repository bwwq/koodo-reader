...
test("merges equal title and author while preserving source variants", () => {
  const groups = groupSourceResults([
    { id: "a", source_id: "one", source_name: "One", source_type: "opds", title: "The Book", authors: ["A. Writer"], media_type: "text" },
    { id: "b", source_id: "two", source_name: "Two", source_type: "legado", title: "the book", authors: ["A Writer"], media_type: "text" },
  ]);
...
test("keeps So Novel result variants in merged search results", () => {
  const groups = groupSourceResults([
    { id: "a", source_id: "sonovel", source_name: "Source A", source_type: "sonovel", title: "同一本书", authors: ["作者"], media_type: "text" },
    { id: "b", source_id: "legado", source_name: "Source B", source_type: "legado", title: "同一本书", authors: ["作者"], media_type: "text" },
  ]);
  expect(groups).toHaveLength(1);
